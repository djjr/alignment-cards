export const categories = [
 ...
 export const cards = [
  ...
  {
    "category": "AP",
    "name": "Beneficence w property name variants",
    "definition": "Act to promote the well-being of others.",
    "people": "(PEOPLE!)Seeking to improve others' conditions, not just avoid harm.",
    ...
    "professionals": "(PROFESSIONALS!) Keeping public safety and welfare in sight even while working primarily for the client.",
    ...
    "failureModes": {
      ...
      "experts": "(EXPERTS!) An expert who disregards public interest, acting as if the consequences of what they help build are other people's problems.",
      ...
      "pros": "(PROS!) an elaboration of how this idea plays out in professional intelligence alignment contexts",
